...
function ContentCard({ index, icon, title, description }: ContentProps) {
  return (
    <div
      className={`${index === 0 ? "border-none" : "border-t md:border-t-0 md:border-l-[1px]"} border-[#f91fc333] shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-6 flex flex-col text-left hover:scale-[1.02] transition-transform duration-300 w-full gap-4 sm:gap-5 leading-loose tracking-wider`}
    >

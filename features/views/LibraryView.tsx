...
function EmptyState() {
  return (
    ...
    >
      ...
      <p className="text-white/25 text-sm">Start liking tracks to add them to your library</p>
    </motion.div>
  );
}
    ...
    <div className="flex flex-col gap-6 sm:gap-8 p-4 sm:p-6 h-full overflow-y-auto overflow-x-hidden pb-24 md:pb-8">
      ...
      <div className="flex flex-col gap-2">
        <div className="relative pl-5">
          ...
          <h1 className="text-2xl font-bold tracking-wide text-white uppercase">Library</h1>
          <p className="text-sm text-white/40 mt-0.5">Your liked tracks</p>
        </div>
      </div>
          ...
          >
            <div className="flex items-center justify-between mb-5">
              <p className="text-white/40 text-sm">
                <span className="text-white/70 font-semibold">{likedTrackIds.length}</span> liked tracks
              </p>
            </div>
